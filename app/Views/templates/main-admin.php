    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bggreen py-4">
            <div class="container-xxl">
                <a class="header fs-1 navbar-brand" href="/Admin/home">CoFFEE BEANS</a>
                ...
                <div class="footer collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                        <li class="nav-item fs-6">
                            <a class="nav-link" aria-current="page" href="/LogOutController/logout">Keluar<i class="bi bi-box-arrow-right ms-2"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
